...
export default function Modal(props) {
  ...
  return (
    <div className="fixed top-0 right-0 bottom-0 left-0 z-50 bg-black/80 flex items-center justify-center">
      <div className="min-[296px] bg-[#343434] rounded-2xl">
        <div className="">
