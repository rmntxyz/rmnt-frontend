...
export default function TopCard({ data }) {
  return (
    <div className="container mx-auto">
      <div className="m-9 flex flex-col md:my-12 lg:my-20 lg:grid lg:grid-flow-col lg:grid-cols-2 lg:items-center">
        ...
        <div className="mt-8 flex flex-col md:mt-12 md:flex-row md:justify-between lg:flex-col lg:order-3">
          ...
          <div>
            <a
              ...
              className="inline-block px-12 py-3.5 border-2 border-ourBlack bg-ourBlack text-white text-lg leading-tight font-extrabold rounded-full transition duration-150 ease-in-out hover:drop-shadow-rmnt md:px-14 md:py-4 md:text-2xl"
            >
              View webtoon
            </a>
          </div>
